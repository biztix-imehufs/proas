...
public class dataList extends DefaultHandler {
	...
	filterDataMulti ff = new filterDataMulti(allEvents,caseClass,activityClass,eventClass,timeStempClass,resourceClass);
	classAnalysis classAnalys;
	HelloProA hello ;
	protected StringBuffer buffer = null;
	
	public dataList(String fileName) {
		this.xmlFileName = fileName;
		//hello= new HelloProA(xmlFileName);
		parseDocument();
		classAnalys = new classAnalysis(dataMulti,caseClass);
		//sorting
