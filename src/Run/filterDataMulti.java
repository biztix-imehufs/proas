...
public class filterDataMulti {
	...
	TimeStempClass timeClass;
	ResourceClass resourceClass;
	 public filterDataMulti(ArrayList<ArrayList<String>> allEvents, CaseClass c, ActivityClass a, EventClass e,TimeStempClass t, ResourceClass r){
	...
	public void setFilter(){
		...
		for(int k=0; k<newFilterE.size();k++){
			...
			activityClass.getFilterActivityList().add(newFilterE.get(k).get(1));
	     	...
	     	timeClass.getFilterTimeStempList().add(newFilterE.get(k).get(3));
